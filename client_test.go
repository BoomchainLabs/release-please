...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Users.New(context.Background(), earnapp.UserNewParams{
		WalletAddress: "walletAddress",
	})
	if userAgent != fmt.Sprintf("EarnApp/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Users.New(context.Background(), earnapp.UserNewParams{
		WalletAddress: "walletAddress",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Users.New(cancelCtx, earnapp.UserNewParams{
		WalletAddress: "walletAddress",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Users.New(deadlineCtx, earnapp.UserNewParams{
			WalletAddress: "walletAddress",
		})
		if err == nil {
