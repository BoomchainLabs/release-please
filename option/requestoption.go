...
// RequestOption is an option for the requests made by the earn-app API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/BoomchainLabs/release-please#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.lerfhub.xyz/api/")
}
...
func WithEnvironmentEnvironment1() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://staging.lerfhub.xyz/api/")
}
